...
Short walkthrough of the main flow: assets and labeling, then dataset creation, then models.
...
Assets browser and folder tree for moving through a project’s files.

![Assets browser](docs/demo/screenshot-01-assets.png)

Active labeling workspace with a seeded bounding box selected on the canvas.

![Labeling workspace](docs/demo/screenshot-02-labeling.png)

Dataset version view showing the generated dataset summary and split state.

![Dataset page](docs/demo/screenshot-03-dataset.png)

Models list for reviewing available model definitions in the project.

![Models list](docs/demo/screenshot-04-models.png)

Model builder view for editing task, dataset version, and model configuration.
