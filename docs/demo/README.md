...
- `screenshot-06-experiments.png`
- `screenshot-07-experiment-run.png`
- `screenshot-08-deploy.png`
- `screenshot-09-mal.png`
...
<p align="center">
  <img src="./hero-demo.gif" alt="Pixel Sheriff walkthrough covering labeling, dataset versioning, experiments, deployment, and model-assisted labeling" width="100%" />
</p>
<p align="center">
...
<p align="center">
  <img src="./screenshot-05-builder.png" alt="Model builder configuration for the README Pet Detector before experiment launch" width="49%" />
  <img src="./screenshot-06-experiments.png" alt="Experiments analytics page showing the seeded README detector run" width="49%" />
</p>
<p align="center">
  <img src="./screenshot-07-experiment-run.png" alt="Experiment detail page with metrics, logs, and ONNX export for the seeded run" width="49%" />
  <img src="./screenshot-08-deploy.png" alt="Deploy page with the README experiment deployed as the active model" width="49%" />
</p>
<p align="center">
  <img src="./screenshot-09-mal.png" alt="Labeling workspace showing pending deployment-assisted MAL predictions for the hero asset" width="49%" />
</p>
...
- It injects a deterministic completed detection experiment run for the seeded demo model before capture.
...
- Deployment creation in the hero and screenshot flows is real; MAL predictions are stubbed only for deterministic review capture.
