...
class SegmentationPipeline(TaskPipeline):
    ...
    def run_training(
        ...
        def _on_epoch(epoch_metrics: SegmentationEpochMetrics) -> None:
            row: dict[str, Any] = {
        ...
        run_status, final_evaluation = run_segmentation_training(
            model_config=job.model_config,
            training_config=job.training_config,
    ...
    def evaluate(
        ...
        evaluation: SegmentationEvaluation | None = training_result.final_evaluation
        if evaluation is None:
            return EvaluationResult(summary={}, per_class={}, raw=None)
        return EvaluationResult(
            summary={"mIoU": float(evaluation.mIoU)},
            per_class={},
            raw=evaluation,
        )
    ...
    def write_evaluation(
        ...
        *,
        ...
        if eval_result.raw is None:
            return
        evaluation: SegmentationEvaluation = eval_result.raw
        payload = {
            "schema_version": "1",
            "task": "segmentation",
            ...
            "overall": {"mIoU": float(evaluation.mIoU)},
    ...
    def export_onnx(
        ...
        *,
        ...
        import torch
        from pixel_sheriff_trainer.segmentation.train import _build_deeplabv3
        ...
        return export_model_to_onnx(
            ...
            class_order=loaders.class_order,
            class_names=loaders.class_names,
            extra_metadata={"task": "segmentation"},
        )


PIPELINE_REGISTRY["segmentation"] = SegmentationPipeline()
